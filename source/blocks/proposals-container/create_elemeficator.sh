#!/bin/sh
parentName=proposals-container
...
end1
cat proposals-container.pug >> newFile.pug
mv -f newFile.pug  proposals-container.pug
...
end3
cat proposals-container.scss >> newFile.scss
mv -f newFile.scss proposals-container.scss
cd ${fileName}
