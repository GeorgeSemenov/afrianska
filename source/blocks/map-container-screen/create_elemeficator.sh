#!/bin/sh
parentName=map-container-screen
...
end1
cat map-container-screen.pug >> newFile.pug
mv -f newFile.pug  map-container-screen.pug
...
end3
cat map-container-screen.scss >> newFile.scss
mv -f newFile.scss map-container-screen.scss
cd ${fileName}
