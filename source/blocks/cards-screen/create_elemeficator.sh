...
end1
cat cards-screen.pug >> newFile.pug
mv -f newFile.pug  cards-screen.pug
...
end3
cat cards-screen.scss >> newFile.scss
mv -f newFile.scss cards-screen.scss
cd ${fileName}
