...
end1
cat our-clients-screen.pug >> newFile.pug
mv -f newFile.pug  our-clients-screen.pug
...
end3
cat our-clients-screen.scss >> newFile.scss
mv -f newFile.scss our-clients-screen.scss
cd ${fileName}
