...
end1
cat zaglushambo.pug >> newFile.pug
mv -f newFile.pug  zaglushambo.pug
...
end3
cat zaglushambo.scss >> newFile.scss
mv -f newFile.scss zaglushambo.scss
cd ${fileName}
