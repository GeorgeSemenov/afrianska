...
end1
cat contact-us-screen.pug >> newFile.pug
mv -f newFile.pug  contact-us-screen.pug
...
end3
cat contact-us-screen.scss >> newFile.scss
mv -f newFile.scss contact-us-screen.scss
cd ${fileName}
