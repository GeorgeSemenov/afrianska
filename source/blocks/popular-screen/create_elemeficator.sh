...
end1
cat popular-screen.pug >> newFile.pug
mv -f newFile.pug  popular-screen.pug
...
end3
cat popular-screen.scss >> newFile.scss
mv -f newFile.scss popular-screen.scss
cd ${fileName}
