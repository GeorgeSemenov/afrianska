...
end1
cat articles-screen.pug >> newFile.pug
mv -f newFile.pug  articles-screen.pug
...
end3
cat articles-screen.scss >> newFile.scss
mv -f newFile.scss articles-screen.scss
cd ${fileName}
